...
$GOPATH/pkg/mod/k8s.io/code-generator\@v0.17.2/generate-groups.sh all zookeeper-operator/generated zookeeper-operator/apis zookeeper:v1alpha1 --go-header-file hack/k8s/codegen/boilerplate.go.txt --output-base=..
